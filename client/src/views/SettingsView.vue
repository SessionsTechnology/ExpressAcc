  ...
  <section v-if="ready" class="settings-page">
    ...
    <v-window v-model="tab">
      ...
      <v-window-item value="users">
        <v-card class="glass-card panel-card settings-panel pa-3 pa-sm-6"><v-card-text><div class="content-section-header settings-toolbar mb-5"><div><h2 class="section-heading">Household users</h2><p class="muted">PIN changes are optional and never displayed after saving.</p></div><v-btn color="primary" prepend-icon="mdi-plus" @click="addUser">Add user</v-btn></div>
      ...
      <v-window-item value="items">
        <v-card class="glass-card panel-card settings-panel pa-3 pa-sm-6"><v-card-text><div class="content-section-header settings-toolbar mb-5"><div><h2 class="section-heading">Shared items</h2><p class="muted">Timed items count down a user’s daily allowance.</p></div><v-btn color="primary" prepend-icon="mdi-plus" @click="items.push({ name: '', description: '', isTimed: true, disabled: false })">Add item</v-btn></div>
      ...
      <v-window-item value="chores">
        <v-card class="glass-card panel-card settings-panel pa-3 pa-sm-6"><v-card-text><div class="content-section-header settings-toolbar mb-5"><div><h2 class="section-heading">Chores and rewards</h2><p class="muted">Submitted chores require admin approval before time is awarded.</p></div><v-btn color="primary" prepend-icon="mdi-plus" @click="addChore">Add chore</v-btn></div>
