...
const ready = ref(false); const saving = ref(false); const savingDarkMode = ref(false); const demoMode = ref(false); const tab = ref(initialTab); const backupFile = ref(null); const openItem = ref(null); const openChore = ref(null)
